...
@Component({
  ...
  styles: `
    ...
    .auth-box {
      width: 350px; padding: 30px; border: 1px solid #00ff00;
      box-shadow: 0 0 30px rgba(0, 255, 0, 0.1); background: #050505;
    }
    .header { color: #00ff00; font-size: 0.8em; font-weight: bold; margin-bottom: 10px; letter-spacing: 2px; text-align: center; }
    ...
    .auth-btn { background: #004444; border: 1px solid #00ff00; color: #00ff00; padding: 12px; font-size: 0.6em; font-weight: bold; cursor: pointer; font-family: inherit; }
    ...
    .oa-btn { flex: 1; background: transparent; border: 1px solid #222; color: #888; padding: 8px; font-size: 0.45em; cursor: pointer; font-family: inherit; font-weight: bold; }
